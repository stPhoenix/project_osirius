    ...
    <ContentComponent>
            ...
            <section className="d-flex flex-column align-items-center justify-content-center">
		      <div className="d-flex flex-column align-items-center justify-content-center">
                <img src={typing} alt="typing" style={{height:'6rem', width:'auto'}} />
		        <h4 className="opacity-50 text-center px-2 mb-4 mt-0">Type word. System will search word in database or in the internet.</h4>
		        <Link className="link-unstyled custom-btn theme-primary px-3 py-1 mb-5" to="/addwords/type" > Add words</Link>
              </div>
              <div className="d-flex flex-column align-top align-items-center justify-content-center">
		        ...
		        <Link className="link-unstyled custom-btn theme-primary px-3 py-1 mb-3" to="/addwords/presets" > Add words</Link>
              </div>
            </section>
	</ContentComponent>
		);
