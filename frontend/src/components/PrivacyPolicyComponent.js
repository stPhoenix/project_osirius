...
<li>The services contained in this section enable the Owner to monitor and analyze web traffic and can be used to keep track of User behavior.</li>
</ul>
<h4> Google Analytics (Google Inc.)</h4>
<ul>
<li>Google Analytics is a web analysis service provided by Google Inc. (&ldquo;Google&rdquo;). Google utilizes the Data collected to track and examine the use of this Application, to prepare reports on its activities and share them with other Google services.<br /> Google may use the Data collected to contextualize and personalize the ads of its own advertising network.</li>
<li>Personal Data collected: Cookies and Usage Data.</li>
<li>Place of processing: United States &ndash;&nbsp;<a href="https://www.google.com/intl/en/policies/privacy/">Privacy Policy</a>&ndash;&nbsp;<a href="https://tools.google.com/dlpage/gaoptout?hl=en">Opt Out</a>. Privacy Shield participant.</li>
</ul>
<p><strong>&nbsp;</strong></p>
...
<p>This Application does not support &ldquo;Do Not Track&rdquo; requests.<br /> To determine whether any of the third-party services it uses honor the &ldquo;Do Not Track&rdquo; requests, please read their privacy policies.</p>
...
<p><strong>&nbsp;</strong></p>
<p>Latest update: August 26, 2018</p>
    </ContentComponent>
        );
};